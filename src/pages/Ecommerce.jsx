  ...
  return (
    <div className="mt-24">
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-48 rounded-xl w-full lg:w-500 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-bold text-gray-400">Earnings</p>
              <p className="text-2xl">Rs 54,567/-</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-10 justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className="text-3xl font-semibold">Rs 6,13,543/-</span>
                  <span
                ...
                <p className="text-gray-500 mt-1">Total Budget</p>
              </div>
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">Rs 2,43,679/-</span>
                </p>
